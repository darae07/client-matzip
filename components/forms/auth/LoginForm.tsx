  ...
  return (
    <div>
      ...
      >
        ...
        <button
          type="submit"
          className="mt-2.5 w-full items-center justify-center rounded-md border  bg-sky-600 py-2 px-2 font-semibold text-white hover:bg-sky-700 disabled:bg-gray-500 md:text-sm"
          disabled={isLoading}
        >
          {isLoading ? (
            <LoadingSpinner
